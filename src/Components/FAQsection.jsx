...
const FAQsection = () => {
    ...
    return (
        <div className="mt-20 lg:px-10 px-0">
            <h1
            initial={{x:-100}}
            animate={ { x: 0 }}
            transition={{
            ...
            data-aos="slide-right"   data-aos-offset="200"
            data-aos-delay="100"
            data-aos-duration="3000"
            data-aos-easing="ease-in-out" className="text-center tex-xl lg:text-5xl font-lato">Frequently Asked Questions</h1 >
            <div className="flex flex-col md:flex-col lg:flex-row-reverse  justify-between gap-2 items-center mt-10">
                <div className="lg:flex-1" data-aos="slide-right"  data-aos-offset="" data-aos-duration="1500" data-aos-easing="ease-in-out">
                ...
                <div className="collapse collapse-plus bg-base-200">
                    ...
                    <div className="collapse-title  font-medium text-lg lg:text-2xl  font-lato">
            ...
            <div data-aos="zoom-in"  data-aos-offset="" data-aos-duration="1500" data-aos-easing="ease-in-out">
