...
const SinglePending = ({pending, setPendings}) => {
  ...
  console.log(pending);
    ...
    return (
        <div>
            <div className="flex flex-col lg:flex-row  overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 p-2">
    <div className=" ">
        <img className=" rounded" src={thumbnail_url} alt="" />
    </div>

    <div className="lg:w-[700px] p-4 md:p-4">
        <h1 className=" lg:translate-x -translate-y-5 font-bold text-red-500">{status}{text}</h1>
