...
const SinglePending = ({pending}) => {
    ...
    <div className="w-[700px] p-4 md:p-4">
        ...
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 flex gap-1 font-semibold">Examine: <span className=" hover:underline">{examine}</span></p>

        <div className="flex mt-2 item-center gap-6">
          <p className=" font-semibold">Assignment_Mark: <span className=" text-blue-700 font-semibold "> {mark}</span></p>
        </div>
        ...
        <div className="flex justify-between mt-3 item-center gap-">
            ...
            <button className="px-2 py-2 text-xs font-bold hover:text-white uppercase transition-colors duration-300 transform rounded dark:bg-gray-700 hover:bg-blue-900   border border-blue-600 btn text-black">give mark</button>
        </div>
    </div>
</div>
        </div>
