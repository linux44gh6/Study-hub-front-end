...
const toggleTheme = () => {
  ...
  return (
    <div className={`navbar  fixed z-20 h-20 shadow transition-colors duration-500 ease-in-out ${isScrolled ? 'bg-[#3498db]' : 'bg-[#ffffff56]'}`}>
        ...
        <div className='flex'>
          {
            user ? <>
              ...
              <div className='dropdown dropdown-end z-50'>
                ...
                <li>
                  <NavLink to='/login' className='btn bg-transparent text-black  hover:bg-transparent hover:scale-105'>Login</NavLink>
                </li>
                <li>
